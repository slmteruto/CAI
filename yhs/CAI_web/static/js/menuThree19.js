...
if(navigator.platform){
    if(filter.indexOf(navigator.platform.toLowerCase()) < 0) {
        document.getElementById("cssLink").href="../static/css/menuThree_css1.css";
    } else {
        document.getElementById("cssLink").href="../static/css/menuThree_web2.css";
    }
}
...
$(function() {
    $('.recommend_prdt').click(function() {
        ...
        window.open(prdt_link, "", "width=1500,height=900");
    });
});