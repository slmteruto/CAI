...
if(navigator.platform){
    if(filter.indexOf(navigator.platform.toLowerCase()) < 0) {
        document.getElementById("cssLink").href="../static/css/menuTwo_css2.css";
    } else {
        document.getElementById("cssLink").href="../static/css/menuTwo_web8.css";
    }
}
